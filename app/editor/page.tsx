    ...
    <div className="min-h-screen bg-[#F4F1EA] text-[#17201B] flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#E3DECF] px-3 py-2 sm:px-6">
        <div className="max-w-[1600px] mx-auto flex flex-wrap items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="relative flex items-center">
                <select
                  ...
                  className="appearance-none bg-[#FAF8F3] border border-[#E3DECF] rounded-lg pl-2.5 pr-7 py-1.5 text-xs font-bold text-ink cursor-pointer hover:border-ink/40 focus:outline-none focus:ring-1 focus:ring-green max-w-[140px] sm:max-w-[220px] md:max-w-[280px] truncate"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-[#2E6B4F] text-white hover:bg-[#24543E] text-xs font-bold transition-colors shadow-2xs"
          ...
          {/* View Mode Switcher */}
          <div className="flex items-center bg-[#FBFAF6] border border-[#E3DECF] rounded-full p-0.5 sm:p-1 shadow-xs">
            <button
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              className="inline-flex px-2.5 sm:px-3 py-1.5 rounded-lg border border-[#2E6B4F] bg-[#2E6B4F] hover:bg-[#24543E] text-white text-[12px] font-bold items-center gap-1.5 transition-all shadow-xs cursor-pointer"
            ...
            >
              ...
              <span>AI Auto-Fill (up to 3 PDFs)</span>
            </button>
            ...
            <button
              onClick={handleSave}
              className={`px-3 sm:px-3.5 py-1.5 rounded-lg text-[12px] font-bold flex items-center gap-1.5 transition-all cursor-pointer shadow-xs ${
                savedStatus
            ...
            {data.general.projectId ? (
              <Link
                ...
                className="px-2.5 sm:px-3 py-1.5 rounded-lg bg-ink text-lime hover:bg-ink/85 text-[12px] font-bold flex items-center gap-1.5 transition-colors shadow-xs"
              ...
              <button
                onClick={handleSave}
                className="px-2.5 sm:px-3 py-1.5 rounded-lg bg-ink/40 text-lime/60 text-[12px] font-bold flex items-center gap-1.5 transition-colors shadow-xs cursor-pointer"
                title="Save passport first to view DPP"
              >
                <span>Save to View</span>
                <ExternalLink size={13} />
              </button>
            )}
          </div>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          ...
          {(viewMode === 'editor' || viewMode === 'split') && (
            ...
            >
              {/* Category Tab Bar */}
              <div className="sticky top-0 z-30 bg-surface border-b border-[#E3DECF] px-3 sm:px-6 py-2 flex gap-1.5 overflow-x-auto no-scrollbar scroll-smooth">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-semibold whitespace-nowrap transition-colors cursor-pointer shrink-0 min-h-[36px] ${
                      activeTab === tab.id
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-white border border-line rounded-lg px-3 py-2 text-[12px] font-mono"
                          />
                        </div>
                        <div>
                          <label className="block text-[11px] font-bold text-muted uppercase tracking-wider mb-1">
                      ...
                      <div className="space-y-3">
                        {(data.measurements?.top || []).map((row, idx) => (
                          <div key={idx} className="bg-white p-3 rounded-xl border border-line space-y-2">
                            ...
                            <div className="grid grid-cols-5 gap-2 pt-1 border-t border-line/60">
                              {SIZES.map(sz => (
                                <div key={sz} className="flex items-center gap-1.5">
                                  <span className="text-[10px] font-mono text-muted">{sz}:</span>
                                  <input
                                    type="number"
                                    step="0.5"
      ...
      <div className="md:hidden fixed bottom-3 left-3 right-3 z-40 bg-[#17201B]/95 backdrop-blur-md border border-[#2A362E] rounded-2xl p-2 px-3 shadow-2xl flex items-center justify-between gap-2">
        <div className="flex items-center bg-black/40 rounded-xl p-0.5">
          <button
            onClick={() => setViewMode('editor')}
        ...
        <div className="flex items-center gap-1.5">
          <button
            onClick={handleClearToBlank}
            className="p-2 rounded-xl bg-white/10 hover:bg-white/20 text-white/80 text-xs font-semibold cursor-pointer"
          ...
          <button
            onClick={handleSave}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-green hover:bg-green-dark text-white text-xs font-bold shadow-xs active:scale-95 transition-transform cursor-pointer"
          >
            {savedStatus ? <Check size={14} /> : <Save size={14} />}
            <span>{savedStatus ? 'Saved!' : 'Save'}</span>
          </button>
          <Link
            href={`/dpp/${data.general.projectId}`}
            className="p-2 rounded-xl bg-lime text-ink hover:bg-lime/80 transition-colors"
